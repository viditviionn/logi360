      ...
      <View className="flex-1 bg-[#F5F5F5] max-w-[700px] shadow-lg rounded-xl ml-[25%] mr-[25%] m-10">
        ...
        <View className="flex-1 pt-8 w-full items-center">
          <View className="w-[59%] flex justify-center">
            <Text className="text-[32px] font-inter-semibold text-[#262727]">Login</Text>
            ...
            {hasFourNines && (
              <Text className="text-[#C30606] font-inter mt-2">
                Mobile number not found in database, try again.
              </Text>
            )}
          </View>
